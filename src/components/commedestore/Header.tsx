...
const Header = () => {
  return (
    <>
      <div className="w-full flex flex-col justify-between items-center px-4 py-2 bg-gray-100 border-b-2 border-gray-200">
      ...
      <div className="w-full flex flex-row justify-center align-center shadow-md">
